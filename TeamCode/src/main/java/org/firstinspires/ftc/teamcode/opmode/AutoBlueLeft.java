...
/**
 * DECODE 2026 – Auto Blue Left.
 * 30s: nhặt bóng, sắp xếp đúng màu (MOTIF), bắn 9 bóng vào goal.
 */
@Autonomous(name = "AUTO BLUE LEFT", group = "DECODE 2026")
public class AutoBlueLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Blue Left: mirror so với Red (âm X cho shoot/park)
        double startX = 0, startY = 0;
        double intakeX = 0, intakeY = 50;
        double shootX = -70, shootY = 50;
        double parkX = -70, parkY = 70;

        AutoRunner runner = new AutoRunner(robot, this, 2,
